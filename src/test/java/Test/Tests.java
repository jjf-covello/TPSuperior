...
public class Tests {
	...
	@Test
	public void testFases() {
		
		Fasores fasor1=new Fasores();
		fasor1.setAmplitud(1);
		fasor1.setEsCoseno(true);
		fasor1.setFase(2*Math.PI);
		fasor1.setFrecuencia(3);
		
		
		System.out.println(fasor1.getFase());
		System.out.println(0-(Math.PI*0.5));
		
		
		Assert.assertEquals(6.283185, fasor1.getFase(), 0.000001);

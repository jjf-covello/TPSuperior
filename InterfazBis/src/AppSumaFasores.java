...
public class AppSumaFasores {
	...
	private void initialize() {
		...
		btnLimpiar.setBounds(318, 255, 84, 23);
		...
		buttonCos_1.setBounds(371, 225, 62, 14);
		...
		btnCalcular.setBounds(224, 255, 84, 23);
		panel.add(btnCalcular);
		
		
		JLabel label_13 = new JLabel(")");
		label_13.setFont(new Font("Arial", Font.PLAIN, 11));
		label_13.setBounds(489, 298, 28, 17);
		panel.add(label_13);
		...
		itDepends.setBounds(337, 296, 36, 20);
		panel.add(itDepends);
		...
		resultadoAmplitud.setBounds(291, 296, 36, 20);
		...
		fase_1.setBounds(501, 174, 43, 20);
		panel.add(fase_1);
		...
		button.setBounds(224, 338, 132, 23);
		panel.add(button);
		...
		fase_2.setBounds(511, 214, 43, 20);
		panel.add(fase_2);

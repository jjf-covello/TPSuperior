...
public class AppOpBasicasPolar {
	...
	private void initialize() {
		...
		label_14.setBounds(364, 301, 19, 32);
		panel.add(label_14);
		...
		resultadoFase.setBounds(324, 308, 32, 20);
		panel.add(resultadoFase);
		
		JLabel label_13 = new JLabel(";");
		label_13.setFont(new Font("Arial", Font.PLAIN, 11));
		label_13.setBounds(311, 302, 12, 32);
		panel.add(label_13);
		
		JLabel label_12 = new JLabel("[");
		label_12.setFont(new Font("Arial", Font.PLAIN, 11));
		label_12.setBounds(263, 302, 19, 32);
		panel.add(label_12);
		btnCociente.setBounds(509, 267, 89, 23);
		...
		btnMultiplicacin.setBounds(399, 267, 100, 23);
		...
		btnResta.setBounds(301, 267, 89, 23);
		panel.add(btnResta);
		...
		fase_1.setBounds(441, 157, 32, 20);
		panel.add(fase_1);
		
		JLabel label_7 = new JLabel("[");
		label_7.setFont(new Font("Arial", Font.PLAIN, 11));
		label_7.setBounds(391, 188, 19, 32);
		panel.add(label_7);

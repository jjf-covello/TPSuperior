...
public class AppOpBasicasBin {
	...
	private void initialize() {
		...
		label_10.setBounds(488, 307, 26, 32);
		panel.add(label_10);
		
		JLabel label_3 = new JLabel("+");
		label_3.setHorizontalAlignment(SwingConstants.CENTER);
		label_3.setFont(new Font("Arial", Font.PLAIN, 11));
		label_3.setBounds(354, 307, 44, 23);
		panel.add(label_3);
		...
		btnMultiplicacin.setBounds(402, 273, 101, 23);
		...
		lblInserteOtroNmero.setBounds(204, 194, 182, 32);
		...
		resultadoParteReal.setBounds(277, 307, 89, 26);
		...
		btnVolverAlInicio.setBounds(204, 350, 154, 23);
